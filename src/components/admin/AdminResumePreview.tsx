...
export function AdminResumePreview({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-75 z-[60] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-gray-900 rounded-lg max-w-6xl w-full max-h-[95vh] overflow-hidden flex flex-col">
        {/* Header */}
        <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between bg-gray-50 dark:bg-gray-800">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400">{resumeTitle} - {template} template</p>
          </div>
          ...
          <div className="flex items-center gap-2">
            ...
            {!loading && (
              <div className="flex items-center gap-1 px-3 py-1 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg">
                ...
                <span className="text-sm font-medium min-w-[60px] text-center dark:text-gray-300">
                  {Math.round(zoom * 100)}%
                </span>
                <button
                  type="button"
